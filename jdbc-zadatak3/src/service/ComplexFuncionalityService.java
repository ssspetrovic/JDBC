...
public class ComplexFuncionalityService {
	...
	public List<AkcijaDTO> ispisAkcije(String naziv, String tip) throws SQLException{
		List<AkcijaDTO> retVal = new ArrayList<AkcijaDTO>();
		akcijaDAO.findByNaziv(naziv, tip).forEach(retVal::add);
		return retVal;
	}
