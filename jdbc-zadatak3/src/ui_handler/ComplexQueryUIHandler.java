...
public class ComplexQueryUIHandler {
	...
	public void prikazAkcTip(){
		System.out.println("Naziv akcije: ");
		String naziv = (MainUIHandler.sc.nextLine());
		System.out.println("Naziv tipa: ");
		String tip = (MainUIHandler.sc.nextLine());
		try {
			if (!komponentaService.existByTip(tip) || !akcijaService.existByNaziv(naziv)) {
				System.out.println("Uneti naziv tipa ili akcije ne postoji!");
				return;
			}
			List<AkcijaDTO> akc = complexQueryService.ispisAkcije(naziv, tip);
