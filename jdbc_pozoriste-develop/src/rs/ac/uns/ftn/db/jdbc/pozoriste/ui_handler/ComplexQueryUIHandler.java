package rs.ac.uns.ftn.db.jdbc.pozoriste.ui_handler;
	...
	public void handleComplexQueryMenu() {
		...
		do {
			...
			case "1":
				...
				break;
			case "2":
				complexQueryService.showReportingForShowingShows();
				break;
			case "3":
				complexQueryService.showComplexQuery();
				break;
			case "4":
				complexQueryService.showMostVisitedShow();
				break;
			case "5":
